...
class HelixUltimateFeatureContact
{
	...
	{
		$conditions = $this->params->get('contactinfo') && ($this->params->get('contact_phone') || $this->params->get('contact_mobile') || $this->params->get('contact_email') || $this->params->get('contact_time') || 1);

		if($conditions)
		{
			$output= '<ul class="sp-contact-info">';
			//<li class=\"sp-contact-phone\">Made in <span style=\"color:#FF0000\">Canada</span></li>
			$output.="
				<li class=\"sp-contact-phone\"><div class=\"sp-schedule-demo\">Schedule a Demo</div></li>";
